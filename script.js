...
ctx.beginPath();
    ...
    const i18n = {
        en: {
            ...
            'reviews.label': '03&nbsp;&middot;&nbsp;REVIEWS',
            'reviews.head': 'PLAYERS&nbsp;SAY',
            'reviews.all': 'ALL&nbsp;REVIEWS&nbsp;ON&nbsp;ITCH.IO&nbsp;&#8599;',
        ...
        ru: {
            ...
            'reviews.label': '03&nbsp;&middot;&nbsp;ОТЗЫВЫ',
            'reviews.head': 'ЧТО&nbsp;ГОВОРЯТ&nbsp;ИГРОКИ',
            'reviews.all': 'ВСЕ&nbsp;ОТЗЫВЫ&nbsp;НА&nbsp;ITCH.IO&nbsp;&#8599;',
